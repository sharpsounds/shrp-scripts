...
clear
printf "\n$magenta Installing Nala because I like it! \n"
sleep 1
apt install -y nala

printf "\n$magenta Configuring prerequisites for Docker! \n"
sleep 1
...
printf "\n$magenta Updating system! \n"
sleep 1
nala update
nala upgrade -y

printf "\n$magenta Installing some packages like!"
sleep 1
